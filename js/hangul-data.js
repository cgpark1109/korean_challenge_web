...
const HangulData = {
  ...
  compound_vowels: [
    ...
    { id: 'cv_yae', char: '\u3152', roman: 'yae', sound: "Like 'ye' in yes (short)" },
    ...
    { id: 'cv_ui', char: '\u3162', roman: 'ui', sound: "Like 'ui' (eu+i combined)" },
  ],
  ...
  words: [
    ...
    { id: 'w_thanks', char: '객사합니다', roman: 'gamsahamnida',   meaning: 'Thank you (formal)' },
    ...
    { id: 'w_what',   char: '뭝',        roman: 'mwo',            meaning: 'What' },
    ...
    { id: 'w_beautiful',     char: '아름답다',   roman: 'areumdapda',     meaning: 'Beautiful' },
  ],
